...
const CardButtonSection = forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => <div ref={ref} className={cn("grid grid-cols-2 gap-6", className)} {...props} />
);
CardButtonSection.displayName = "CardButtonSection";
...
const CardSubTitle = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLHeadingElement>>(
  ({ className, ...props }, ref) => (
